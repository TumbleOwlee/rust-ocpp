...
use crate::v2_0_1::enumerations::monitor::MonitorEnumType;
use crate::v2_0_1::enumerations::set_monitoring_status::SetMonitoringStatusEnumType;
...
static_assertions::assert_impl_all!(SetMonitoringResultType: serde::Serialize, serde::de::DeserializeOwned, Clone, core::fmt::Debug, PartialEq, Default);
