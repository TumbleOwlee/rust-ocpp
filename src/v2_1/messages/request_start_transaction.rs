...
use crate::v2_1::datatypes::charging_profile::ChargingProfileType;
...
use crate::v2_1::enumerations::request_start_stop_status::RequestStartStopStatusEnumType;
...
static_assertions::assert_impl_all!(RequestStartTransactionRequest: serde::Serialize, serde::de::DeserializeOwned, Clone, core::fmt::Debug, PartialEq, Default, validator::Validate);
