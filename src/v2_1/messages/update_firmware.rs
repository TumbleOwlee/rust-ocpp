...
use crate::v2_1::datatypes::firmware::FirmwareType;
...
static_assertions::assert_impl_all!(UpdateFirmwareRequest: serde::Serialize, serde::de::DeserializeOwned, Clone, core::fmt::Debug, PartialEq, Default, validator::Validate);
