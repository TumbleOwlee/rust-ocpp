...
use crate::v2_1::datatypes::composite_schedule::CompositeScheduleType;
...
static_assertions::assert_impl_all!(GetCompositeScheduleRequest: serde::Serialize, serde::de::DeserializeOwned, Clone, core::fmt::Debug, PartialEq, Default, validator::Validate);
