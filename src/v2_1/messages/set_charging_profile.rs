...
static_assertions::assert_impl_all!(SetChargingProfileRequest: serde::Serialize, serde::de::DeserializeOwned, Clone, core::fmt::Debug, PartialEq, Default, validator::Validate);
